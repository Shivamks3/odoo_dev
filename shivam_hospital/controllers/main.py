...
class AppointmentController(http.Controller):
    ...
    @http.route('/shivam_hospital/appointments', auth='user', type='json')
...
class Hospital(http.Controller):
    ...
    def patient_webform(self, **kw):
        ...
        return http.request.render('shivam_hospital.create_patient', {'patient_name': 'Odoo Mates Test 123',
    ...
    def create_webpatient(self, **kw):
        ...
        return request.render("shivam_hospital.patient_thanks", {})
    ...
    def hospital_patient(self, **kw):
        ...
        return request.render("shivam_hospital.patients_page", {
            'patients': patients
        })
